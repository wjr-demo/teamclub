...
CREATE TABLE `app_subject_user` (
  ...
  `com_qq_permit` varchar(64) DEFAULT NULL,
  `net_ip` varchar(16) DEFAULT NULL,
  `net_speed` varchar(16) DEFAULT NULL,
  `net_permit` varchar(64) DEFAULT NULL,
  `computer_no` varchar(16) DEFAULT NULL,
  `computer_passwd` varchar(64) DEFAULT NULL,
  `computer_config` varchar(128) DEFAULT NULL,
