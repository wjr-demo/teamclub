...
CREATE TABLE `app_subject_user` (
  ...
  `identify_no` varchar(15) DEFAULT NULL,
  `birthday` datetime DEFAULT NULL,
  `marriage_status` int(11) DEFAULT '0',
  `education_level` int(11) DEFAULT '0',
  `strong_point` varchar(256) DEFAULT NULL,
  ...
  `family_relation` varchar(16) DEFAULT NULL,
  `expected_leave` datetime DEFAULT NULL,
  `com_qq_num` datetime DEFAULT NULL,
  `com_qq_passwd` datetime DEFAULT NULL,
  `com_qq_permit` datetime DEFAULT NULL,
  `net_ip` datetime DEFAULT NULL,
  `net_speed` datetime DEFAULT NULL,
  `net_permit` datetime DEFAULT NULL,
  `computer_no` datetime DEFAULT NULL,
  `computer_passwd` datetime DEFAULT NULL,
  `computer_config` datetime DEFAULT NULL,
  `remark` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
